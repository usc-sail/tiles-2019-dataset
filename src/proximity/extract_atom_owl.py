...
if __name__ == '__main__':
    ...
    for participant_id in participant_list:
        ...
        if os.path.exists(os.path.join(delevery_root_path, 'Phase2', id, 'AtomProximity', id + '_AtomOwlInOne.csv')) is False:
            continue
        ...
        owl_in_one_df = pd.read_csv(os.path.join(delevery_root_path, 'Phase2', id, 'AtomProximity', id + '_AtomOwlInOne.csv'))
        ...
        make_dir(os.path.join(saving_path, 'atomproximity', 'owlinone'))

        with open(os.path.join(saving_path, 'atomproximity', 'owlinone', participant_id + '.csv'), 'w') as csv_output:
        ...
        final_df = pd.read_csv(os.path.join(saving_path, 'atomproximity', 'owlinone', participant_id + '.csv'))
        final_df.to_csv(os.path.join(saving_path, 'atomproximity', 'owlinone', participant_id + '.csv.gz'), index=False, compression='gzip')
        os.remove(os.path.join(saving_path, 'atomproximity', 'owlinone', participant_id + '.csv'))
